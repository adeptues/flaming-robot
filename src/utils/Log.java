 ...
 * 
 * Messages sent to the logger are sent to its {@link java.io.PrintStream} based on priority. Only messages
 * above the minimum priority are written to the log. The priority levels from least to most important are
 * DEBUG, INFO, WARNING, and ERROR. The log can be set to write to any print stream, with a null value
 * defaulting to System.err. Convenience methods are provided for the logging levels.
 * 
