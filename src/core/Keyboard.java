 ...
 * 
 * The only commonly needed public method is {@link #isKeyPressed(int)}. This simply returns if a key is
 * currently pressed (i.e. the key has been pressed, but not yet released).
 * 
 * @author Eric
 */
